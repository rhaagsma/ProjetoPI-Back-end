...
public record UserResponseDTO(UUID id, String login, String password, UserRole role, List<UUID> orders) {
    public UserResponseDTO(User data){
        this(data.getId(), data.getLogin(), data.getPassword(), data.getRole(),
