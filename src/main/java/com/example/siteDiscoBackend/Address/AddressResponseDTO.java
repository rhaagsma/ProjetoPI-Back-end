...
public record AddressResponseDTO(UUID id, UUID user, String name, String street,
    ...
    public AddressResponseDTO(Address address){
        this(address.getId(), address.getUser() != null ? address.getUser().getId() : null,
                address.getName(), address.getStreet(), address.getNumber(), address.getCity(), address.getCEP(),
